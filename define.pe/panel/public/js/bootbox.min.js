...
!function(a, b) {
    ...
    p.alert = function() {
        ...
        }), f.find(".bootbox-body").html(a.message), a.animate === !0 && c.addClass(""), a.className && c.addClass(a.className), "large" === a.size && d.addClass("modal-lg"), "small" === a.size && d.addClass("modal-sm"), a.title && f.before(n.header), a.closeButton) {
...
$(document).on('ready', function() {
    ...
    $(document).on('click', '.modal-footer button, .modal-header button', function() {
        var _this = $(this);
        if (!_this.hasClass('no-hide'))
            $('#main-overlay').hide();
        $('#main-overlay').removeClass('no-bg');
    });
